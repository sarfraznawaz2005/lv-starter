...
class RouteList extends Command
{
     ...
     * @var string
     */
    protected $description = 'Lists all routes.';
    ...
    protected function getRouteInformation(Route $route)
    {
        ...
        $method = $this->applyBGColors(implode("|", array_diff($route->methods(), ['HEAD'])));
        $uri = preg_replace('#({[^}]+})#', "<fg=yellow>$1</>", $route->uri());
        $action = preg_replace('#(@.*)$#', "<fg=yellow>$1</>", $route->getActionName());
    ...
    protected function applyBGColors($method)
    {
        $methods = [
